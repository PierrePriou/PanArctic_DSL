...
CTD data were collected regularly during each of the survey. To match CTD records with acoustic data, I rasterized CTD data on the same grid as the acoustic data. I tried two different grids; the WGS84 projection (EPSG:4326) with grid cells of 2°lon * 1°lat, and the EASE-Grid 2.0 North (EPSG:6931) with grid cells of 100 km * 100 km which is the default grid for sea-ice data. For each cell I calculated the mean conservative temperature and absolute salinity between 200 and 1000 m depth.
...
```{r EPSG-4326-map-CTD, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
...
```{r EPSG-6931-map-CTD, message=FALSE, warning=FALSE, fig.width=8, fig.height=7}
