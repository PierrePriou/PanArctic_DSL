...
```{r EPSG-4326-map-acoustic, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}
...
```{r EPSG-6931-map-acoustic, message=FALSE, warning=FALSE, fig.width=8, fig.height=7}
