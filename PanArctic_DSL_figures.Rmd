...
ggsave("plots/Figure_LM_SA_lat.png", lm_SA_lat, 
       height = 2.25, width = 4.5, dpi = 600, units = "in")
lm_SA_lat
```
...
lm_SA_lat <- LM_area_res %>%
  ...
  theme(legend.position = "right", 
        ...
        axis.line = element_line())
# Combine plots
p_map_NASC_LM <- plot_grid(map_DSL, lm_SA_lat, rel_heights = c(1, 0.8),
                           ncol = 1, align = "v", axis = "lr",
                           labels = "auto", label_size = 9, 
                           label_y = c(0.9, 1.05)) 
# Save and display plot
ggsave("plots/Fig3_map_LM_NASC.png", p_map_NASC_LM, 
       height = 4, width = 6.5, dpi = 600, units = "in")
p_map_NASC_LM
```
...
GAMSAI_velo <- predSA_I %>%
  ...
  scale_fill_manual(name = "LME",
                    values = met.brewer("Johnson", n = 6, direction = -1)) +
  coord_cartesian(xlim = c(-0.1, 4.1), ylim = c(-2, 32), expand = F) +
