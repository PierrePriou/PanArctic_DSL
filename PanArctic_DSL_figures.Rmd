...
p_Sv_prof_lines <- Sv_prof_median %>%
  ...
  geom_line(aes(x = depth_round, y = Sv_median, col = year)) + # Sv profiles per year and median
  geom_vline(data = CM_prof, aes(xintercept = CM), lty = 2) + # Center of mass
  geom_text(data = CM_prof, aes(x = CM -10, y = -102, label = as.character(CM_round)),
...
ggsave("plots/Fig2_Sv_profiles_lines.png", p_Sv_prof_lines, height = 3.5, width = 7, dpi = 600, units = "in")
p_Sv_prof_lines
```
