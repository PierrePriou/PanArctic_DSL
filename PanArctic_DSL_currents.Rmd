...
map_velo <- velo_new %>%
  ...
  # Scales
  scale_fill_viridis_c("V", option = "viridis", limits = c(0, 6.5), end = 1, oob = scales::squish,
...
map_base <- velo_new_HD %>%
  ...
  geom_path(data = arctic_circle, aes(x = x, y = y), col = "white", lty = 2, size = 0.3) +
  # Graticules 
  geom_path(data = latitudes, aes(x = x, y = y, group = lat), col = "grey20", size = 0.15, alpha = 0.75) +
  geom_path(data = longitudes, aes(x = x, y = y, group = lon), col = "grey20", size = 0.15, alpha = 0.75) +
  # Plot North Pole
  ...
  # Scales
  scale_fill_cmocean("", name = "delta", limits = c(0, 6.5), end = 0.95, oob = scales::squish, 
