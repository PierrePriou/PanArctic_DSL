...
```{r fig1-map-station-laea, fig.align='center', fig.height=3.25, fig.width=6}
...
```{r fig2-Sv-profile-area-year, fig.align='center', dpi=100, fig.width=6.5, fig.height=3}
...
```{r Sv-profiles-area-year-in-progress, eval=FALSE, fig.align='center', fig.width=6.5, fig.height=3}
