...
```{r GAMS-basis-size-residuals, eval=FALSE}
...
```{r GAMS-residuals-covariates, message=FALSE, eval=FALSE}
...
```{r shrink-GAMS-selection, eval=FALSE}
# Model S
...
```{r GAMS3-residuals-covariates, message=FALSE, eval=FALSE}
appraise(GAM_S3)
...
```{r GAMS-pretty-ggplot, fig.height=8, fig.width=7, eval=FALSE}
GAMS_velo <- pred_S %>%
  filter(var == "v") %>%
  ggplot() +
...
```{r GAMSAS-basis-size-residuals, eval=FALSE}
...
```{r GAMSAS-residuals-covariates, message=FALSE, eval=FALSE}
...
```{r shrink-GAMSAS-selection, eval=FALSE}
# Model S
...
```{r GAMSAS3-residuals-covariates, message=FALSE, eval=FALSE}
appraise(GAMSA_S3)
...
```{r GAMSAS-pretty-ggplot, fig.height=8, fig.width=7, eval=FALSE}
