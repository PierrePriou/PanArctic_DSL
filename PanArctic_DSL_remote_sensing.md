...
plot(test_sf2["thetao"], axes = TRUE) # Not working
```
...
plot(test_sf3["thetao"], axes = TRUE) # Work
```
...
phy %>%
  ...
  geom_vector(aes(x = x, y = y, dx = vxo, dy = vyo, mag = Mag(vxo, vyo)),
